...
const positiveIntSchema = zod_1.z.number({ coerce: true }).int().positive();
...
__decorate([
    (0, decorators_1.Env)('N8N_RUNNERS_GRANT_TOKEN_TTL', positiveIntSchema),
    __metadata("design:type", Number)
], TaskRunnersConfig.prototype, "grantTokenTtl", void 0);
__decorate([
