...
let LogWriterConfig = class LogWriterConfig {
    constructor() {
        ...
        this.logFullPath = '';
        this.maxMessagesPerParse = 10_000;
        this.maxTotalMessagesPerFile = 500_000;
    }
};
__decorate([
...
__decorate([
    (0, decorators_1.Env)('N8N_EVENTBUS_LOGWRITER_LOGFULLPATH'),
    __metadata("design:type", String)
], LogWriterConfig.prototype, "logFullPath", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_EVENTBUS_LOGWRITER_MAXMESSAGESPERPARSE'),
    __metadata("design:type", Number)
], LogWriterConfig.prototype, "maxMessagesPerParse", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_EVENTBUS_LOGWRITER_MAXTOTALMESSAGESPERFILE'),
    __metadata("design:type", Number)
], LogWriterConfig.prototype, "maxTotalMessagesPerFile", void 0);
